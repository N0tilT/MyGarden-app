...
class GardenVisualPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: const _GardenVisualBody(),
    );
  }
}

class _GardenVisualBody extends StatefulWidget {
  const _GardenVisualBody();

  @override
  _GardenVisualBodyState createState() => _GardenVisualBodyState();
}

class _GardenVisualBodyState extends State<_GardenVisualBody> {
